...
@ComponentScan(basePackages = {"com.ega.dao"})
public class TestConfig {

  @Bean
  DataSource dataSource() throws SQLException {
    // SimpleDriverDataSource s =
    // new SimpleDriverDataSource(DriverManager.getDriver("jbdc:mysql://localhost/beirutdb"),
    // "jbdc:mysql://localhost/beirutdb", "root", "");
    // return s;
